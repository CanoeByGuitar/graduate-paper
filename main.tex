...
\usepackage[CJKbookmarks,breaklinks,hidelinks]{hyperref}
...
\setlength{\itemsep}{0pt} % 设置列表项之间的间距为0pt
\newcommand{\thesisTitleZh}{基于物质点法的非粘性双向流固耦合仿真研究}
\newcommand{\thesisTitleEn}{Research on the Simulation of Non-stiky Two-way Fluid-solid Coupling Based on the Material Point Method}
\newcommand{\authorname}{王晨辉}
\newcommand{\director}{王长波}
\newcommand{\school}{计算机科学与技术学院}
\newcommand{\authornameEn}{Chenhui Wang}
\newcommand{\directorEn}{Changbo Wang}
\newcommand{\schoolEn}{School of Computer Science and Technology}
\newcommand{\stuid}{51255901108}
...
\input{chapter-adaptive/apative.tex}
\input{chapter-zeno/zeno.tex}
\input{chapter-future/future.tex}
