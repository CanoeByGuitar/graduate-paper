...
\newcommand{\thesisTitleZh}{基于自适应物质点法的非粘性双向流固耦合仿真研究}
\newcommand{\thesisTitleEn}{Research on the Simulation of Non-stiky Two-way Fluid-solid Coupling Based on the Adaptive Material Point Method and the High-performance Simulation Framework}
